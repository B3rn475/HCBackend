...
exports.regexp.points.color = /(rgb\(([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9])\))|(rgba\(([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9])\))\b/;

exports.regexp.history.color = /(rgb\(([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9])\))|(rgba\(([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9])\))\b/;
