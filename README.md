...
* segmentation:
    ...
    * points: []
        ...
        * color: {type: String, validate: /(rgb\(([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9])\))|(rgba\(([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9])\))\b/}
    * history: []
        * x: { type: Number, min: 0}
        * y: { type: Number, min: 0}
        * size: {type: Number, min: 1}
        * color: {type: String, validate: /(rgb\(([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9])\))|(rgba\(([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9]),[ ]*([0-2][0-9]{2}|[0-9]{2}|[0-2][0-9])\))|end\b/}
        * timestamp : {type:Date}
* started_at: {type: Date},
* completed_at: {type: Date},
